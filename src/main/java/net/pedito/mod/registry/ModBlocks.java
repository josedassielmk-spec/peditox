...
import net.pedito.mod.item.PeditoChestBlockItem;
...
public class ModBlocks {
    ...
    public static void register() {
        ...
        PEDITO_CHEST_ITEM = registerBlockItem("pedito_chest", PEDITO_CHEST, new Item.Properties());
    }
    ...
    private static Item registerBlockItem(String name, Block block, Item.Properties properties) {
        ResourceKey<Item> key = ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Pedito.MOD_ID, name));
        Item item = new PeditoChestBlockItem(block, properties.setId(key));
