...
public class PeditoDanceGoal extends Goal {
    ...
    public boolean canUse() {
        ...
        return this.pedito.isJukeboxDancing() || this.pedito.getRandom().nextInt(chance) == 0;
    }
    ...
    public void tick() {
        ...
        if (this.danceTimer % 10 == 0 && this.pedito.level() instanceof ServerLevel serverLevel) {
            serverLevel.sendParticles(ParticleTypes.NOTE, 
                this.pedito.getX(), this.pedito.getY() + 1.2, this.pedito.getZ(), 
                1, 0.2, 0.2, 0.2, 1.0);
        }
    }
}
